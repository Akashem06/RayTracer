...
use ray_tracer::material::{Lambertian, Material, Metal};
...
fn main() {
    ...
    let metal_1_config = (Srgb::new(0.05, 0.0, 0.05), 0.0);
    let metal_2_config = (Srgb::new(1.0, 0.5, 1.0), 0.15);
    let metal_3_config = (Srgb::new(0.5, 1.0, 0.5), 0.15);
